...
#define LOCKDIR "/fileserv/"	/* where to put locks */

/*
 * If you want the static parts of your playground on a read-only file
 * system, define VAR_PLAYGROUND to be where the variable parts are kept.
 */
#define VAR_PLAYGROUND "/fileserv/"
...
//#define SUSPEND		/* let ^Z suspend the game */ // No suspend in RefOS.
#endif
...
//#  define GETRES_SUPPORT // No getUID in RefOS.
# endif
#else
...
#define getuid() 1 // No getUID in RefOS.